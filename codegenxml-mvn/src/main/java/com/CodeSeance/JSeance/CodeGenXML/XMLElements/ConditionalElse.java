...
/**
 * Class for implementing "Else" functionality
 *
 * @author Andres Murillo
 * @version 1.0
 */
class ConditionalElse extends HierarchicalNode
{
    public ConditionalElse(Element element)
    {
        super(element);
    }
    ...
    public void onContextEnter(Context context)
    {
        ...
        {
            context.LogInfoMessage(log, "Else", "Processing children");
