 ...
 */
class Case extends HierarchicalNode
{
    public Case(String arguments, Template.Position position)
    {
    ...
    public void loadChildren(Template template, Node parent)
    {
        ...
        {
            template.throwError("Case statement needs to be a direct child of a Switch statement");
        }
