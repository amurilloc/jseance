...
/**
 * Class for checking that the included file has the required set of defines available in the context
 *
 * @author Andres Murillo
 * @version 1.0
 */
class IncludeRequiredDefine extends Node
{
    public IncludeRequiredDefine(Element element)
    {
        super(element);
    }
